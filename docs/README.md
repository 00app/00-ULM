...
Product and ops docs for the **00-00** repo. Code lives in `app/` and `lib/`.
...
See **[HANDBOOK.md](HANDBOOK.md)** → Documentation index.

## Not moved here (by design)

| Path | Why |
|------|-----|
| **[../README.md](../README.md)** | GitHub / npm repo root |
| **`../config/README.md`** | Config folder convention |
| **`../.cursor/rules/`** | Cursor agent rules (not product docs) |
