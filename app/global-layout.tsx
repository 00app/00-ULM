...
export const APP_PAGES_REGISTRY = [
  { path: ROUTES.HOME, sourceFile: 'app/page.tsx', name: 'Home / redirect' },
  ...
  { path: ROUTES.PROFILE_SUMMARY, sourceFile: 'app/profile/summary/page.tsx', name: 'Profile summary' },
  { path: ROUTES.ZONE, sourceFile: 'app/zone/page.tsx', name: 'Zone' },
  { path: ROUTES.ZAI, sourceFile: 'app/zai/page.tsx', name: 'Zai' },
