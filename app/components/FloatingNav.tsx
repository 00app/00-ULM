...
/**
 * FloatingNav - Only persistent navigation
 * - Appears on Zone, Likes, Zai Chat, Settings
 * - Never appears during intro or questions
 * - Three icons: Heart, Circle, Leaf
 * - Active state: BLUE fill
 * - Inactive: ICE outline
 */
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          borderRadius: 27,
          border: 'none',
          background: active === 'likes' ? 'var(--color-blue)' : 'var(--color-ice)',
          color: active === 'likes' ? 'var(--color-ice)' : 'var(--color-blue)',
          display: 'flex',
          alignItems: 'center',
      ...
      >
        <svg width="20" height="20" viewBox="0 0 35 32" fill="none">
          <path 
      ...
      <button
        ...
        style={{
          ...
          borderRadius: 27,
          border: 'none',
          background: active === 'zone' ? 'var(--color-blue)' : 'var(--color-ice)',
          color: active === 'zone' ? 'var(--color-ice)' : 'var(--color-blue)',
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'center',
          cursor: 'pointer',
      ...
      <button
        ...
        style={{
          ...
          borderRadius: 27,
          border: 'none',
          background: active === 'summary' ? 'var(--color-blue)' : 'var(--color-ice)',
          color: active === 'summary' ? 'var(--color-ice)' : 'var(--color-blue)',
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'center',
          cursor: 'pointer',
      ...
      >
        <svg width="20" height="15" viewBox="0 0 40 31" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <button
        ...
        style={{
          ...
          borderRadius: 27,
          border: 'none',
          background: active === 'chat' ? 'var(--color-blue)' : 'var(--color-ice)',
          color: active === 'chat' ? 'var(--color-ice)' : 'var(--color-blue)',
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'center',
          cursor: 'pointer',
