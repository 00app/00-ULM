...
/** Site-wide footer — Instagram + © line + Privacy & Data (Marvin H4). */
export function Footer({ className = '' }: FooterProps) {
  return (
    <footer className={`site-footer ${className}`.trim()} aria-label="Site footer">
      <div className="site-footer__social-row">
        <a
          href={INSTAGRAM_HREF}
          target="_blank"
          rel="noopener noreferrer"
          className="site-footer__ig-link"
          aria-label="Zero Zero on Instagram"
        >
          <InstagramGlyph className="site-footer__ig-glyph" />
        </a>
      </div>
